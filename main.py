...
import datetime
from CDCNN.generate_pic import ConstractiveLoss
from CDCNN import train
from CDCNN.DASNET import Finalmodel
import sys
from scipy.io import savemat
sys.path.append('../global_module/')


from CDCNN.generate_pic import aa_and_each_accuracy, sampling,load_dataset, generate_png, generate_iter,applyPCA
from global_module.Utils import record, extract_samll_cubic
...
lr, num_epochs, batch_size = 0.0005, 10, 32
